...
contract('ERC1155MintBurnPackedBalance', (accounts) => {
    ...
    context('When ERC1155MintBurn contract is deployed', () => {
        ...
        beforeEach(async () => {
            let abstract = await utils_1.AbstractContract.fromArtifactName('ERC1155MetaMintBurnPackedBalanceMock');
        ...
        describe('_mint() function', () => {
            ...
            it('should NOT allow anyone to call _mint()', async () => {
                ...
                await utils_1.expect(tx).to.be.rejectedWith(utils_1.RevertError('ERC1155MetaMintBurnPackedBalanceMock: INVALID_METHOD'));
            });
...
//# sourceMappingURL=ERC1155MintBurnPackedBalance.spec.js.map