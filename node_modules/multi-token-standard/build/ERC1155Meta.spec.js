...
contract('ERC1155Meta', (accounts) => {
    const MAXVAL = new utils_2.BigNumber(2).pow(256).sub(1); // 2**256 - 1
    ...
    describe('safeTransferFrom() (Meta) Function', () => {
        ...
        let feeTokenInitBalance = new utils_2.BigNumber(100000000);
        let feeType = 0; // ERC-1155
        let feeToken;
        let feeTokenAddress;
        let feeTokenDataERC1155;
        let transferObj;
        let gasReceipt;
        let data;
        let conditions = [
        ...
        conditions.forEach(function (condition) {
            context(condition[2], () => {
                beforeEach(async () => {
                    ...
                    feeTokenDataERC1155 = ethers.utils.defaultAbiCoder.encode(['address', 'uint256', 'uint8'], [feeTokenAddress, feeTokenID, feeType]);
                    // Gas Receipt
                    gasReceipt = {
                        gasLimit: 200000,
                        baseGas: 21000,
                    ...
                    // fee token in uint
                    feeToken = new utils_2.BigNumber(feeTokenID);
                ...
                describe('When signature is valid', () => {
                    ...
                    it('should REVERT if transfer leads to overflow', async () => {
                        ...
                        // @ts-ignore
                        const tx = operatorERC1155Contract.functions.safeTransferFrom(ownerAddress, receiverAddress, id, amount, data);
                        await utils_1.expect(tx).to.be.rejectedWith(utils_1.RevertError("SafeMath#add: OVERFLOW"));
                    });
                    ...
                    it('should REVERT if invalid response from receiver contract', async () => {
                        ...
                        await utils_1.expect(tx).to.be.rejectedWith(utils_1.RevertError("ERC1155#_safeTransferFrom: INVALID_ON_RECEIVE_MESSAGE"));
                    });
                    ...
                    describe('When gas is reimbursed', () => {
                        ...
                        it("should PASS if another approved ERC-1155 is used for fee", async () => {
                            let erc1155Contract2 = await erc1155Abstract.deploy(ownerWallet);
                            ...
                            feeTokenDataERC1155 = ethers.utils.defaultAbiCoder.encode(['address', 'uint256', 'uint8'], [erc1155Contract2.address, feeTokenID, 0]);
                            ...
                            data = await utils_1.encodeMetaTransferFromData(transferObj, gasReceipt);
                            // @ts-ignore
                            const tx = operatorERC1155Contract.functions.safeTransferFrom(ownerAddress, receiverAddress, id, amount, data, { gasLimit: 2000000 });
                            await utils_1.expect(tx).to.be.fulfilled;
                        });
                        it("should REVERT if NOT approved ERC-1155 is used for fee", async () => {
                            ...
                            // @ts-ignore
                            const tx = operatorERC1155Contract.functions.safeTransferFrom(ownerAddress, receiverAddress, id, amount, data, { gasLimit: 2000000 });
                            await utils_1.expect(tx).to.be.rejectedWith(utils_1.RevertError('ERC1155#safeTransferFrom: INVALID_OPERATOR'));
                        });
                        ...
                        it("should PASS if approved ERC20 is used for fee", async () => {
                            let erc20Abstract = await utils_1.AbstractContract.fromArtifactName('ERC20Mock');
                            let erc20Contract = await erc20Abstract.deploy(ownerWallet);
                            ...
                            let feeTokenDataERC20 = ethers.utils.defaultAbiCoder.encode(['address', 'uint8'], [erc20Contract.address, 1]);
                            gasReceipt = { gasLimit: 10000, baseGas: 1000, gasPrice: 1,
            ...
            context(condition[2], () => {
                ...
                describe('When signature is valid', () => {
                    ...
                    it('should REVERT if invalid response from receiver contract', async () => {
                        ...
                        await utils_1.expect(tx).to.be.rejectedWith(utils_1.RevertError("ERC1155#_safeBatchTransferFrom: INVALID_ON_RECEIVE_MESSAGE"));
                    });
                    it('should PASS if valid response from receiver contract', async () => {
                        transferObj.receiver = receiverContract.address;
                        data = await utils_1.encodeMetaBatchTransferFromData(transferObj, gasReceipt);
...
//# sourceMappingURL=ERC1155Meta.spec.js.map